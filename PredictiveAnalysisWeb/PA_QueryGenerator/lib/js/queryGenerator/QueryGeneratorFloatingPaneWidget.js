...
define([
  ...
  './QueryGeneratorWidget'
],
  function(declare, domClass, domStyle, FloatingPane, QueryGeneratorWidget) {
    return declare(
      [FloatingPane],
      {
        _minimized: false,
        ...
        constructor: function(params) {
          if (params) {
            this.map = params.map;
            this.gpServiceUrl = params.gpServiceUrl;
          }
        },
        ...
        postCreate: function() {
          ...
          this.queryGeneratorWidget = new QueryGeneratorWidget({map: this.map, gpServiceUrl: this.gpServiceUrl});
          this.queryGeneratorWidget.placeAt(this.containerNode);
          this.queryGeneratorWidget.startup();
        },
