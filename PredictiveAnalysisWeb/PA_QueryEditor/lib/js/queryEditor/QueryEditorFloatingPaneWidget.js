...
define([
  ...
  function(declare, domClass, domStyle, FloatingPane, QueryEditorWidget) {
    return declare(
      [FloatingPane],
      {
        _minimized: false,
        ...
        postCreate: function() {
          ...
          this.queryEditorWidget = new QueryEditorWidget({map: this.map, gpServiceUrl: this.gpServiceUrl});
